...
const TicketPrice = (props: Props) => {
  return (
    <div className='mx-auto w-[1200px]'>
        <h2 className='uppercase text-3xl text-center mt-10 font-bold text-[#272727]'>Giá vé</h2>
        ...
        <table className='tick_price'>
            <thead>
                <tr>
                    <th className='w-72' rowSpan={2}></th>
                    <th className='bg-yellow-500' colSpan={3}>Từ thứ 2 đến thứ 6</th>
                    <th className='bg-red-500 text-white' colSpan={3}>Thứ 7, CN và ngày Lễ</th>
                </tr>
            ...
            <tbody>
                ...
                <tr>
                    <td>Từ 12:00 đến trước 18:00</td>
                    <td>60.000</td>
        ...
        <div className='mt-10 grid grid-cols-2 gap-10 mb-20'>
            <div>
                <p className='mb-5'><span className='font-bold'>* Ghế vip </span>là các ghế có vị trí ngồi xem tốt nhất trong rạp. <br /> Vip seats are the best positions in the cinema.</p>
                <p className='mb-5'>
                    <span className='font-bold'>* Vé trẻ em:</span>
                    <br />  - Trẻ em có chiều cao từ 0,7m đến 1,3m: Giảm 10.000đ/vé đối với phim 2D, 3D.
                ...
                <p className='mt-10'>
                    <span className='font-bold'>* Ưu đãi cho người cao tuổi (trên 55 tuổi): Giảm 10.000đ/vé</span> đối với phim 2D (yêu cầu xuất trình CMND để hưởng giá vé ưu đãi).
                    <br /> Senior over 55 years old: Discount 10.000/2D ticket.
                </p>
            </div>
            <div>
                <p>
                    <span className='font-bold'>* Áp dụng giá vé ngày Lễ, Tết cho các ngày:</span>
                    <br /> - Các ngày nghỉ Lễ, Tết theo quy định của nhà nước: Tết Nguyên Đán, Tết Dương
                    <br />Lịch, ngày Giỗ Tổ Hùng Vương 10/3 AL, ngày 30/4, 1/5, nghỉ lễ Quốc Khánh 2/9.
                ...
                <span className='font-bold'>* Holiday fare is applied on:</span>
                    <br />- The public holidays as prescribed by state: New year, Lunar new year, Hùng's King festival (March 10th - lunar calendar) , April 30th, May 1st, National Day holiday on September 2nd.
                    <br />- Days: Valentine, Women's Day, Noel.
                    <br />- Compensatory days off due to holidays coinciding with Saturday and Sunday.
                </p>
            </div>
        </div>
    </div>
